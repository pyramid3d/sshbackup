@echo off
:: @file   : runbackup-windows.cmd
:: @version: 2019-04-22
:: @created: 2017-04-11
:: @author : pyramid
:: @brief  : run backup for device (Windows)
...
SET SOURCE=%drive%/users/%user%/bin
...
echo "--- copy: /mnt/nasdata/folder.organization.txt /%datadir%/"
CALL lib\runbackup-inc.cmd :copyFromSSH /folder.organization.txt %drive%/%datadir%/
